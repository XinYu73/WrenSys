...
def split_bagging(id_prop, start, bagging_size, folder):
    ...
    for i in tqdm(range(start, start + bagging_size)):
        ...
        valid.to_csv(
            os.path.join(folder, "id_prop_bag_" + str(i + 1) + "_valid.csv"),
            mode="w",
            index=False,
            header=False,
        )
        ...
        train.to_csv(
            os.path.join(folder, "id_prop_bag_" + str(i + 1) + "_train.csv"),
            mode="w",
            index=False,
            header=False,
        )
        ...
        test_unlabel.to_csv(
            os.path.join(folder, "id_prop_bag_" + str(i + 1) + "_test-unlabeled.csv"),
            mode="w",
            index=False,
            header=False,
        )
...
class CIFData(Dataset):
    def __init__(
        ...
        with open(id_prop_file) as f:
            ...
            ]  # [['mp-69', '0.0'], ['mp-80', '0.28024546000000017'], ['mp-697196', '1.2102673790909106'] ... ]
